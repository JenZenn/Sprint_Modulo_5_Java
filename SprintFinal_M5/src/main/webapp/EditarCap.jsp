...
<body>
	<div class="hero_area">
				...
				<nav class="navbar navbar-expand-lg custom_nav-container ">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<div
							...
							<ul class="navbar-nav">
								<li class="nav-item"><a class="nav-link" href="ListarCapacitacion.jsp">Listar Capacitación</a></li>
     ...
     <%
     	Capacitacion cap;
     	cap = CapacitacionDAO.obtenerCap(Integer.parseInt(request.getParameter("id")));
     %>           
                       
                            <h2>Editar Capacitación</h2>
                       
						<form action="SVEditarCap" method="post">
						 <fieldset class="form-group">
                            <label>Id</label> 
                            <input type="text" value="<%=cap.getId()%>"class="form-control" name="id">
                        </fieldset>
                        <fieldset class="form-group">
                            <label>Nombre</label> 
                            <input type="text" value="<%=cap.getNombre()%>"class="form-control" name="nombre">
                        </fieldset>
                        <fieldset class="form-group">
                            <label>Detalle</label> 
                            <input type="text"  value="<%=cap.getDetalle()%>"class="form-control" name="detalle">
                        </fieldset>
